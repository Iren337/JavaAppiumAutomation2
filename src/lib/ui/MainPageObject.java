...
public class MainPageObject {
    ...
    public WebElement waitForElementAndClickWithDelay(String locator, String error_message, long timeoutInSeconds, long delay) throws InterruptedException {
    ...
    public String waitForElementAndGetAttribute(String locator, String atribute,  String error_message, long timeoutInSeconds)
    {
        WebElement element = waitForElementPresent(locator, error_message, timeoutInSeconds);
    ...
    public String assertElementPresent(String locator, String atribute)
    {
        By by = this.getLocatorByString(locator);
